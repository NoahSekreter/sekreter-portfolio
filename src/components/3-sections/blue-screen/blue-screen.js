  ...
  return (
    <div className='blue-screen'>
      <div className='blue-screen__message'>
        ...
        <p>Need an expert on your team? Consider sending an email over at <a href='mailto:nsekreter@gmail.com'>nsekreter@gmail.com</a> to get in contact with an expert and onboard team into your team.</p>
        <p></p>
      </div>
    </div>
  );
